...
1. Download [the patch](https://github.com/Scroptss/T7Patch/releases/v3.04/).
...
1. Download [the linux zip](https://github.com/Scroptss/T7Patch/releases/v3.04/) and extract the files into your Black Ops 3 installation folder
