...
1. Download [the patch](https://github.com/Scroptss/T7Patch/releases/).
...
1. Download [the linux zip](https://github.com/Scroptss/T7Patch/releases/) and extract the files into your Black Ops 3 installation folder
